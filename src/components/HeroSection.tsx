...
export const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-hero">
      ...
      <div
        className="absolute top-32 right-16 text-primary/20 animate-float"
        style={{ animationDelay: "1s" }}
      >
        <Search size={20} />
      </div>
      <div
        className="absolute bottom-40 left-20 text-primary/20 animate-float"
      ...
      <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="relative">
          ...
          <div
            className="absolute -bottom-6 -right-6 bg-card/90 backdrop-blur-sm p-4 rounded-2xl shadow-card animate-float"
