...
import { ArrowLeft, MapPin, Phone, Clock, AlertTriangle, HeartPulse, ShieldCheck, Star } from "lucide-react";
  ...
  const veterinarios = [
    {
      ...
      direccion: 'Av. Principal de Las Mercedes, Centro Comercional Paseo Las Mercedes, Nivel C2',
      telefono: '0212-991-1234',
      horario: '24 horas / 7 días',
      servicios: ['Emergencias', 'Hospitalización', 'Cirugía', 'Laboratorio', 'Rayos X'],
      destacado: true,
      calificacion: 4.8,
      imagen: 'https://images.unsplash.com/photo-1582456891955-9a3dd54b5755?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80'
    },
    {
      id: 2,
      ...
      horario: '24 horas / 7 días',
      servicios: ['Emergencias', 'Cirugía', 'Ecografía', 'Laboratorio', 'Farmacia'],
      calificacion: 4.7,
      imagen: 'https://images.unsplash.com/photo-1583512603806-077998240d7a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80'
    },
    {
      id: 3,
      nombre: 'Clínica Veterinaria La Castellana',
      direccion: 'Av. Francisco de Miranda, Centro Plaza, Nivel C1, Los Palos Grandes',
      ...
      calificacion: 4.5,
      imagen: 'https://images.unsplash.com/photo-1583336663277-620dc1996580?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80'
    },
    {
      id: 4,
      ...
      calificacion: 4.3,
      imagen: 'https://images.unsplash.com/photo-1587300003388-59208cc962cb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80'
    },
    {
      id: 5,
      nombre: 'Veterinaria Los Naranjos',
      direccion: 'Av. Principal de Los Naranjos, Edif. Galerías, PB, Los Naranjos',
      telefono: '0212-239-4567',
      horario: '24 horas / 7 días',
      servicios: ['Emergencias', 'Hospitalización', 'Cirugía', 'Laboratorio'],
      destacado: true,
      calificacion: 4.9,
      imagen: 'https://images.unsplash.com/photo-1601758228041-f3b2795255f1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80'
    }
  ];
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-muted-foreground mt-3 max-w-2xl">
              Encuentra atención veterinaria de emergencia cerca de ti en Caracas y Miranda
            </p>
          </div>
        </div>
        ...
        <div className="mb-12 bg-card p-6 rounded-xl border border-border">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <h2 className="text-xl font-semibold mb-2">Buscar veterinarios</h2>
              ...
              <div className="md:flex">
                <div className="md:w-1/3 h-48 md:h-auto overflow-hidden">
                  <img 
                    ...
                    onError={(e) => (e.currentTarget.src = 'https://images.unsplash.com/photo-1583336663277-620dc1996580?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80')}
                    loading="lazy"
                  />
                </div>
                <div className="p-6 md:w-2/3">
                  <div className="flex justify-between items-start">
                    ...
                    <Button variant="outline" size="sm" asChild>
                      <a href={`tel:${veterinario.telefono}`} className="gap-1">
        ...
        <div className="mt-16 bg-primary/5 border border-primary/10 rounded-2xl p-8">
          <div className="max-w-2xl mx-auto">
            <h2 className="text-2xl font-bold mb-4 text-center">¿Qué hacer en una emergencia veterinaria?</h2>
