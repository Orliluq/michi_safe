...
const availableCats = [
  {
    ...
    image: "https://i.ibb.co/MxW4mQ80/hombre-con-su-adorable-gato-mascota.jpg",
    vaccinated: true,
    sterilized: false,
  ...
  },
  {
    ...
    image: "https://i.ibb.co/8LPJTcYc/cono-marron-despues-de-la-cirugia-inyeccion-para-un-animal-veterinario-en-guantes-con-una-inyeccion.jpg",
    vaccinated: true,
    sterilized: true,
